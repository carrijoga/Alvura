...
public class MainLayoutBase : LayoutComponentBase
{
    ...
    {
        var isDarkModeString = await Js.InvokeAsync<string>("localStorage.getItem", "AlvuraisDarkMode");
    ...
    protected async Task ToggleDarkMode()
    {
        ...
        await Js.InvokeVoidAsync("localStorage.setItem", "AlvuraisDarkMode", _isDarkMode.ToString());
    }
    ...
    protected MudTheme _theme = new()
    {
        ...
        Typography = new Typography()
        {
            ...
            {
                FontFamily = ["Roboto", "-apple-system", "BlinkMacSystemFont", "Segoe UI", "Oxygen", "Ubuntu",
